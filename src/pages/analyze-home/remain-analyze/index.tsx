...
import style from '../template-analyze/style.less';
// 业务组件
import StatisticsSearch from '../template-analyze/components/statistic-search';
import GlobalSearch from '../template-analyze/components/global-search';
import CompareSearch from '../template-analyze/components/compare-search';
import Table from '../template-analyze/components/result-table';
...
import {
  ...
  useAdvertiseModel,
  useBaseModel,
} from '../template-analyze/model';

import { supersetRequestData } from '../template-analyze/model/process';
import { getModuleDetail } from '../template-analyze/model';
import { updateModuleData } from '../template-analyze/model/api';
import { saveAnalysisModule } from '../retained-analyze/model/api';
import moment from 'moment';
import ChineseNameMap from '../template-analyze/const';
