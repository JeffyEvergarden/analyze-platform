  ...
  if (req.query.type === 'advertise') {
    res.json({
      ...
      datas: {
        ...
        analysisName: '33',
        analysisData:
          '{"statisticsSearch":{"childrenList":[{"event":"fate","attribute":"用户数","relation":"AND","innerList":[],"edit":false}]},"globalSearch":{"childrenList":[{"subject":"select","operator":"==","params":"test1"}]},"compareSearch":{"groupBy":["activity_name"],"daterange":[]},"moduleType":"sub_activity_2","processDiyColumn":[],"titleList":[{"value":"prod_type","name":"产品类型"},{"value":"praticipation_type","name":"参与方式"},{"value":"prod_code","name":"进件产品"},{"value":"channel_num","name":"渠道"},{"value":"day_id","name":"事件发生日期"},{"value":"batch_date","name":"批次日期"},{"name":"下拉框","value":"select","type":"fields","dataType":"select","list":[{"name":"测试1","value":"test1"},{"name":"测试2","value":"test2"}]},{"name":"下拉框2","value":"select2","type":"fields","dataType":"select","list":[{"name":"测试3","value":"test3"},{"name":"测试4","value":"test4"}]},{"name":"输入框","value":"input","type":"fields","dataType":"input"},{"name":"时间选择器","value":"dateTime","type":"fields","dataType":"dateTime"},{"name":"数字框","value":"numbr","type":"fields","dataType":"number","list":[]},{"name":"活动名称","value":"activity_name","type":"fields","dataType":"input"},{"name":"活动ID","value":"activity_id","type":"fields","dataType":"input"}]}',
      },
    });
    return;
  }
