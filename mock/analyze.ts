...
const getRefreshList = (req: any, res: any) => {
  ...
  res.json({
    ...
    data: {
      ...
      proportion: [
        {
          init_event_num0: '100.00%',
          init_event_num1: '0.00%',
          init_event_num2: '100.00%',
          init_event_num3: '6.333%',
          next_event_num1: '100.00%',
          next_event_num2: '100.00%',
          next_event_num3: '0.00%',
          next_event_num0: '0.00%',
          next_event_num4: '100.00%',
          strategy_id: `2id`,
          strategy_name: `2name`,
        },
      ],
